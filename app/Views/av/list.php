                     ...
                     <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                         <div class="row">
                             ...
                             <?php }
                                    ...
                                    echo "<h2 style='float:left;color:#fff;width:100%;padding-top:3rem;'><center>ไม่พบหนังที่ค้นหา</center></h2>";
                                }
                                ?>
                         </div>
                     </div>
                         ...
                         <div class="box-menu__menu color-menu">
                             ...
                             <?php foreach ($category_id as $value) { ?>
                                 <h3><a href="<?php $cateid = $value['category_id'];
                                                echo base_url('/genres/' . $cateid . '/' . urlencode($value['category_name'])); ?>" class="box-menu-submenu category-size-menu"><?php echo $value['category_name']; ?></a></h3>
                             <?php } ?>
                         </div>
                     </div>
