...
<head>
    ...
    <link rel="stylesheet" href='<?php echo $docavURL . "assets/css/font-awesome.min.css"; ?>'>
        ...
        <div class="col-lg-3">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url(); ?>">
                    <img alt="Brand" class="logo-size" src="<?= $path_setting . $setting['setting_logo'] ?>" style="width:55%">
                </a>
            </div>
        </div>
        ...
        <div class="col-lg-9">
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <form class="navbar-form navbar-left" role="search" method="get" id="formsearch-clip">
                        <div class="form-group">
                            <input type="text" value="" id="search-clip" class="form-control" placeholder="ค้นหาหนัง">
                        </div>
