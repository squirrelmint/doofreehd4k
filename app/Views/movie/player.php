...
<head>
    <meta charset="utf-8" />
    <script src="<?php echo $docmvURL ?>assets/js/jwplayer.js"></script>
    <script src="<?php echo $docmvURL ?>assets/js/g23lrur.js"></script>
    <script src="https://cdn.jwplayer.com/libraries/rYlCdkEJ.js"></script>
    <link rel="stylesheet" href='<?php echo $docmvURL ?>assets/css/player.css?v=1'>
...
<body class="if-size">
    ...
    <script>
        ...
        function setMovie() {
            getmovie("playervideo", "<?= $url_play ?>", "100%", false);
        } 
